...
export const WATCHLIST_NO_TICKER_TOAST = "Watchlist is empty — no tickers to refresh yet.";

export const TEMPLATES_EMPTY = "No saved templates yet";

// Template name validation
export const TEMPLATE_NAME_MAX = 60;
export const TEMPLATE_NAME_REQUIRED = "Template name cannot be empty. Give it a memorable name.";
...
export const TEMPLATE_NAME_INVALID_FALLBACK = "Template name invalid. Please check again.";

export const WATCHLIST_SAVED_TOAST = (name: string) => `Watchlist saved as "${name}"`;
