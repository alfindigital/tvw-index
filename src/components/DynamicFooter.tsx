...
export function DynamicFooter() {
  ...
  return (
    <footer className="afd-foot relative mt-10 flex flex-wrap items-center justify-between gap-4 overflow-hidden rounded-2xl border border-border bg-card px-5 py-4">
      <style>{`
        ...
        .afd-rot { position: relative; height: 36px; min-width: 210px; flex: 0 0 auto; }
        .afd-item {
