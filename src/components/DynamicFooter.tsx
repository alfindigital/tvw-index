...
export function DynamicFooter() {
  ...
  return (
    <footer className="afd-foot relative flex flex-wrap items-center justify-between gap-3 overflow-hidden rounded-xl border border-border bg-card px-4 py-2.5">
      <style>{`
        ...
        .afd-rot { position: relative; height: 28px; min-width: 180px; flex: 0 0 auto; }
        .afd-item {
