...
export function DynamicFooter() {
  ...
  return (
    <footer className="afd-foot relative flex flex-wrap items-center justify-between gap-3 overflow-hidden rounded-xl border border-border bg-card px-4 py-1.5">
      <style>{`
