  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto w-full max-w-5xl px-4 pb-10 pt-5 sm:px-6 sm:pt-8">
        ...
        <footer className="mt-20 border-t border-border/60 bg-transparent">
          <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-3 px-4 py-6 text-[11px] text-muted-foreground sm:flex-row sm:px-6 sm:py-8">
            ...
            <nav aria-label="Sosial media" className="flex items-center gap-1">
              {[
                { href: "https://instagram.com/lotmetrik", label: "Instagram", Icon: Instagram },
                { href: "https://t.me/lotmetrik", label: "Telegram", Icon: Send },
                { href: "https://x.com/lotmetrik", label: "X (Twitter)", Icon: Twitter },
                {
