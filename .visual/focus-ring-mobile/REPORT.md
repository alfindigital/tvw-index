...
- save tap: ![save tap](mobile-light-save-tap.png)
- refresh blur: ![refresh blur](mobile-light-refresh-blur.png)
- refresh tab: ![refresh tab](mobile-light-refresh-tab.png)
...
- save tap: ![save tap](mobile-dark-save-tap.png)
- refresh blur: ![refresh blur](mobile-dark-refresh-blur.png)
- refresh tab: ![refresh tab](mobile-dark-refresh-tab.png)
